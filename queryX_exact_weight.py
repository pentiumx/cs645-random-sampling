...
def main():
        ...
        for sample in samples:
            ...
            for c in comp:
                ...
                supplier_table = pandas.read_table(str(c)+'_tbl/supplier.tbl', delimiter="|", header=None,
                ...
                nation_table = pandas.read_table(str(c)+'_tbl/nation.tbl', delimiter="|", header=None,
                ...
                print("Running Algo now")
                cls.algorithm1([nation_table, supplier_table, customer_table, orders_table, lineitem_table], sample)
